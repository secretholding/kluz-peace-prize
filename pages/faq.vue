    ...
    <center-l size="wide">
      <ul>
        <li>
          ...
          <p class="answer">"PeaceTech" encapsulates the strategic deployment of innovative technologies to reinforce peace, prevent conflicts, and steer peacebuilding initiatives. It harnesses, for instance:</p>
          <ul>
        ...
        <li>
          <p class="question">What does the Prize entail?</p>
          <p class="answer">The award grants the selected winner $20,000 for their accomplishments in the field and to support the further advancement of their project in the emerging field of technologies for peace.</p>
        </li>
        <li>
          <p class="question">What are the criteria used for selection?</p>
          <p class="answer">The Selection Committee will use the following achievement-oriented criteria for selection:</p>
          <ul>
            ...
            <li>Scalability and Sustainability: Illustrations of successful expansions beyond the initial pilot, demonstrating the project's growth potential;</li>
            <li>Collaborative Success: Instances of leveraging collaboration and partnerships that have unlocked new opportunities or enhanced the project's impact.</li>
          </ul>
        </li>
        <li>
          <p class="question">Who is on the Selection Committee?</p>
          <p class="answer">The Selection Committee will consist of the founding donor, and a group of distinguished international experts and recognized leaders in the fields of peace, technology, investments, and international affairs.</p>
        </li>
        <li>
          <p class="question">Who’s eligible to apply?</p>
          <p class="answer">The Kluz Prize for PeaceTech welcomes individuals and organizations worldwide, who have distinguished themselves through proven achievements or accomplishments, or innovative projects related to application of transformative technologies in building, supporting, keeping, and promoting peace.</p>
          <p class="answer">Applications can be submitted individually or as a group, with the organization's name and legal representative indicated.</p>
          <p class="answer">Please note, we are not seeking applications proposing new projects. This grant will only be awarded to established projects which have had an impact in the field.</p>
        </li>
        <li>
